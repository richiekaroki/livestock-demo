  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 min-h-[44px] min-w-[44px] rounded-lg hover:bg-bg-secondary transition-colors cursor-pointer"
        aria-expanded={open}
        aria-haspopup="true"
      >
        ...
        <div className="absolute right-0 top-full mt-2 w-56 bg-bg-secondary border border-border rounded-xl shadow-lg py-2 z-50">
          ...
          <div className="border-t border-border mt-1 pt-1">
            <button
              ...
              className="w-full text-left px-4 py-2 min-h-[44px] text-sm text-error hover:bg-error/5 transition-colors cursor-pointer flex items-center"
            >
              Sign out
            </button>
          </div>
