  ...
  const exportToPDF = () => {
    ...
    try {
      ...
      const htmlContent = `
        ...
        <body>
          <div class="header">
            <h1>Wam Mfugo Livestock Report</h1>
            <p>Generated on ${new Date().toLocaleDateString("en-KE", { year: "numeric", month: "long", day: "numeric" })}</p>
            <p style="margin-top: 5px; font-weight: bold;">Wam Mfugo System - Kenya</p>
          </div>
          <div class="summary">
          ...
          <div class="footer">
            <p><strong>Wam Mfugo System</strong></p>
